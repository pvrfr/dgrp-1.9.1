...
#define IDENT_DIGIDRP_H "$Id: digirp.h,v 1.6 2004/05/26 16:23:41 scottk Exp $"
...
#define DIGI_GETLINK	_IOW('e', 103, link_t)	/* Get link parameters */
#define DIGI_SETLINK	_IOW('e', 104, link_t)	/* Set link parameters */
 ...
 ************************************************************************/
#define DIGI_GETA	_IOR('e', 94,digi_t)	/* Read params		*/

#define DIGI_SETA	_IOW('e', 95,digi_t)	/* Set params		*/
#define DIGI_SETAW	_IOW('e', 96,digi_t)	/* Drain & set params	*/
#define DIGI_SETAF	_IOW('e', 97,digi_t)	/* Drain, flush & set params */

#define	DIGI_GETFLOW	_IOR('e', 99, digiflow_t)/* Get startc/stopc flow */
						/* control characters 	 */
#define	DIGI_SETFLOW	_IOW('e', 100,digiflow_t)/* Set startc/stopc flow */
						/* control characters	 */
#define	DIGI_GETAFLOW	_IOR('e', 101,digiflow_t)/* Get Aux. startc/stopc */
						/* flow control chars 	 */
#define	DIGI_SETAFLOW	_IOW('e', 102,digiflow_t)/* Set Aux. startc/stopc */
						/* flow control chars	 */
